...
import pe.edu.upc.gymfit.ui.bot.ChatBotFragment.WebAppInterface.*
...
import pe.edu.upc.gymfit.ui.bot.BaseChatFragment
...
constructor(
...
): BaseChatFragment(R.layout.fragment_chatbot, viewModelFactory) {
    ...
    fun loadPasswordResetWebView(){
        ...
        webView.loadUrl(Constants.CHATBOT_URL)
